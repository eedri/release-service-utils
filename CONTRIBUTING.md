...
- **Task scripts**: Task implementations go in `scripts/python/tasks/internal/`
...
- **Unit tests**: Co-located with source files (e.g., `helpers/tests/` next to `tasks/internal/tests/`)
